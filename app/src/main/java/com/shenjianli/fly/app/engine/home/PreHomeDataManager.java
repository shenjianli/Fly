...
import com.shenjianli.fly.app.engine.home.bean.ChoicenessData;
import com.shenjianli.fly.app.engine.home.bean.ItemData;
import com.shenjianli.fly.app.engine.home.bean.PlatformData;
import com.shenjianli.fly.app.engine.home.bean.ProjectData;
import com.shenjianli.fly.app.engine.home.bean.SecKillData;
import com.shenjianli.fly.app.engine.home.bean.SlideData;
...
public class PreHomeDataManager {
	...
	private Subscriber<ItemData> itemSubscriber;
	...
	private void getHomeData() {
		...
		homeService.getItemData()
				.map(new HttpResultFunc<ItemData>())
				.subscribeOn(Schedulers.io())
				.unsubscribeOn(Schedulers.io())
				.observeOn(AndroidSchedulers.mainThread())
	...
	private void initSubscriber() {
		...
		itemSubscriber = new Subscriber<ItemData>() {
			@Override
			public void onCompleted() {
	...
	public void setItem(ItemData mItem) {
		this.mItem = mItem;
	}

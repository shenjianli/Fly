package com.shenjianli.fly.test.retrofit;
...
import com.shenjianli.fly.test.retrofit.net.HttpObserver;
import com.shenjianli.fly.test.retrofit.net.api.UserApi;

package com.shenjianli.fly.test.retrofit.net.api;


import com.shenjianli.fly.test.retrofit.data.LoginRequest;
import com.shenjianli.fly.test.retrofit.data.entity.UserEntity;
import com.shenjianli.fly.test.retrofit.net.service.UserService;
